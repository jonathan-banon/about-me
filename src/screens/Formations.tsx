export default function Formations() {
    return (
        <div className="formations-container">
            <div className="w-3/4 animate__animated  animate__fadeInRight" style={{ animationDelay: '0s' }}>
            ...
            <div className="w-3/4 animate__animated  animate__fadeInRight" style={{ animationDelay: '1s' }}>
                <ul className="list-disc">
            ...
            <div className="w-3/4 animate__animated  animate__fadeInRight" style={{ animationDelay: '2s' }}>
                <ul className="list-disc">
                    <p className="font-bold text-2xl">Brevet Supérieur Sous-officier Armée de l'Air : 2021</p>
                    <li className="ml-16">
                        <p className="text-xl">Diplôme militaire ( Bac + 2 )</p>
                    </li>
                </ul>
            </div>
        </div>
